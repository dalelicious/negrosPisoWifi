<div class="row" style="margin-top:50px;">
	...
	<div class="row" style="margin-top:30;">
		<div class="col-md-12">
      <center>
			<form action="<?=$ROOT;?>video/process.php?action=add" class="form-horizontal" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="link" autocomplete="off" value="" autofocus="" required="">
					</div>
				</div>
