    ...
    <div class="container-fluid" style="padding: 0px 0px 8px 0px;">
        <div class="row">
            <div class="col-md-4 col-xs-12" style="padding-top: 8px;">
                <h4 class="no-gap">My Products</h4>
            </div>
            <div class="col-md-8 col-xs-12 no-gap">
                ...
                <div class="col-md-4 col-xs-3" style="padding-top: 8px;">
                    <div class="pull-right">
                        <a href="../admin/?view=addItem" type="button" id="btn-new-item" class="btn btn-green" style="font-size: 12px;">Add a new item</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <td>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                          ...
                                          <h4 class="title">
                                              <?=$row->name;?>
                                              <span class="pull-right"><?=$row->brand;?></span>
                                          </h4>
