    ...
    <div class="container-fluid" style="padding: 0px 0px 8px 0px;">
        <div class="row">
            <div class="col-md-4 col-xs-12" style="padding-top: 8px;">
                <h4 class="no-gap">Basic Parts</h4>
            </div>
            <div class="col-md-8 col-xs-12 no-gap">
                ...
                <div class="col-md-4 col-xs-3" style="padding-top: 8px;">
                    <div class="pull-right">
                        <a href="../admin/?view=addComponents" type="button" id="btn-new-item" class="btn btn-green" style="font-size: 12px;">Add a new part</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel-body no-gap">
                <div class="table-container" style="margin-top: 8px;">
                    <table class="table table-filter">
                        <tbody>
                        <?php foreach($componentsList as $row) { ?>
                            <tr class="">
                                <td>
                                    <div class="media">
