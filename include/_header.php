<?php include $ROOT."include/_zero.php"; ?>

<body>
    <div>
        <nav class="navbar navbar-light navbar-expand-md navigation-clean fixed-top" id="mainHeader">
            <div class="container"><a class="navbar-brand" href="<?=$ROOT?>./"><img src="<?=$ROOT;?>include/assets/img/logo.png" id="brand-logo"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
