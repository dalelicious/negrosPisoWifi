<div class="row" style="margin-top:50px;">
    ...
    <div class="col-md-6 text-right">
        <div>
          <button class="btn btn-primary round-button" onclick="location.href='./admin?view=user-add'">Add New User </button>
        </div>
    </div>
</div>
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <button class="btn btn-primary btn-lg" onclick="location.href='<?=$ROOT;?>admin?view=user-update&Id=<?=$key->Id;?>'">Update</button>
